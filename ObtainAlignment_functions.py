...
def obtain_alignment(old_assembly, new_assembly, directory, threads, ToUpdate, alignment_pickle, aligner_switch,
	...
	with open(delta_directory, "r") as delta_file:
					...
					for dataset in ToUpdate:
						...
						if(dataset!="Genome"):
							...
							for subfile in ToUpdate[dataset]:
								...
								"./temporary_directory/{}_{}:{}_{}_A".format(subfile[0], current_oldID, block[0], block[1]) ,
								...
								"./temporary_directory/{}_{}:{}_{}_B".format(subfile[0], current_oldID, block[0], block[1]) ,
								"./temporary_directory/updated_{}_{}:{}_{}_B".format(subfile[0], current_oldID, block[0], block[1]),
		...
		#Run show coords
			Popen("show-coords -c -T -H {}/Filtered.delta > {}/summary.coords".format(alignment_pickle, alignment_pickle) ,shell=True).wait()
